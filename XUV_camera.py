# -*- coding: utf-8 -*-
"""
Combined XUV Spectrometer Monitor
Created on Mon Mar 25 11:25:56 2024
Modified for combined functionality with GUI
...
class XUVSpectrometerGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("XUV Spectrometer Monitor")
...
#        self.camera_name = "Basler Emulation (0815-0000)" # Select this for testing
    ...
    def create_widgets(self):
        ...
        self.roi_label = ttk.Label(roi_frame, text="ROI: Not set", wraplength=250)
        self.roi_label.pack(pady=2)
        self.proj_label = ttk.Label(roi_frame, text="Projection: Not set", wraplength=250)
